...
<body>
	...
	<section id="main-content">
			...
			<div class="row">
				<div class="panel-heading">
					<h3 class="panel-title">
						<i class="glyphicon glyphicon-list"></i> 자세한 팀 현황
					</h3>
					<br /> <select id="teamId" name="teamId" class="selectpicker"
						onchange="refreshpage(value)">
						<c:forEach var="team" items="${teamList}">
							<c:choose>
								<c:when test="${team.teamId == teamid}">
									<option value="${team.teamId}" selected="selected">
		...
		<section id="genreRank" class="col-lg-12">
			<div class="row">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="table table-striped">
							...
							<tbody>
								<c:forEach var="genre" items="${genreinfo}">
									<tr>
										<td>${genre.rank}</td>

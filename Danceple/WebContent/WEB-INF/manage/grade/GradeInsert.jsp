			...
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						...
						<form action="gradeInsertAction" method="post" class="form-horizontal style-form">
						
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label">등급 아이디</label>
                                
                                <div class="col-sm-10">
                                	<input type="text" id="gradeId" name="gradeId" class="form-control" />
                                </div>
                            </div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" id="gradeName" name="gradeName" class="form-control"/>
								</div>
							</div>

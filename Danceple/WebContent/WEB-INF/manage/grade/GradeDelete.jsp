			...
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						...
						<form action="gradeDeleteAction" method="post" class="form-horizontal style-form">
						
							<div class="form-group">
								<label class="col-lg-2 col-sm-2 control-label"> 등급 아이디 </label>
                                
                                <div class="col-lg-10">
                                	<p class="form-control-static">${gradeVO.gradeId}</p>
                                	<input type="hidden" id="gradeId" name="gradeId" value="${gradeVO.gradeId}">
                                </div>
                            </div>
						
							<div class="form-group">
								<label class="col-lg-2 col-sm-2 control-label"> 등급 이름 </label>
                                
                                <div class="col-sm-10">
									<p class="form-control-static">${gradeVO.gradeName}</p>
								</div>
							</div>

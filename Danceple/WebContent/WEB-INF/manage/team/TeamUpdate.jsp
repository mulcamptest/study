			...
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						<h4 class="mb"><i class="fa fa-angle-right"></i> Edit Team</h4>
						<form action="teamUpdateAction" method="post" class="form-horizontal style-form" >
						
							<div class="form-group">
								<label class="col-lg-2 col-sm-2 control-label"> 팀 아이디 </label>
                                
                                <div class="col-sm-10">
                                	<p class="form-control-static">${teamVO.teamId}</p>
                                	<input type="hidden" id="teamId" name="teamId" class="form-control" value="${teamVO.teamId}" />
                                </div>
                            </div>
						
							<div class="form-group">
								<label class="col-lg-2 col-sm-2 control-label"> 팀 이름 </label>
                                
                                <div class="col-sm-10">
									<input type="text" id="teamName" name="teamName" class="form-control" value="${teamVO.teamName}" />
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 팀 요일 </label>
                                
                                <div class="col-sm-10">
									<input type="text" id="teamDay" name="teamDay" class="form-control" value="${teamVO.teamDay}" />
								</div>
							</div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
									<input type="text" id="location" name="location" class="form-control" value="${teamVO.location}" />
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 정규 시간 </label>
                                
                                <div class="col-sm-10">
									<input type="text" id="mainTime" name="mainTime" class="form-control" value="${teamVO.mainTime}" />
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 연습 시간 </label>
                                
                                <div class="col-sm-10">
									<input type="text" id="preTime" name="preTime" class="form-control" value="${teamVO.preTime}" />
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 팀 소개 </label>
                                
                                <div class="col-sm-10">
									<input type="text" id="teamUrl" name="teamUrl" class="form-control" value="${teamVO.teamUrl}" />
								</div>
							</div>

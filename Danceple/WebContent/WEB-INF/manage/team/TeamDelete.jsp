			...
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						<h4 class="mb"><i class="fa fa-angle-right"></i> Delete Team</h4>
						<form action="teamDeleteAction" method="post" class="form-horizontal style-form" >
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                	<p class="form-control-static">${teamVO.teamName}</p>
								</div>
							</div>

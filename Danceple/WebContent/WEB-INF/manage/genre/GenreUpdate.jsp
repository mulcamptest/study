...
<body>
	...
	<section id="main-content">
		<section class="wrapper">
			<h3><i class="fa fa-angle-right"></i> 장르 관리</h3>
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						<h4 class="mb"><i class="fa fa-angle-right"></i> Edit Genre</h4>
						<form action="genreUpdateAction" method="post" class="form-horizontal style-form">
						
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 장르 아이디 </label>
                                
                                <div class="col-sm-10">
                                	<p class="form-control-static">${genreVO.genreId}</p>
                                	<input type="hidden" id="genreId" name="genreId" class="form-control" value="${genreVO.genreId}" />
                                </div>
                            </div>
						
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 장르 이름 </label>
							...
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 장르 소개 </label>

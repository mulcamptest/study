			...
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						<h4 class="mb"><i class="fa fa-angle-right"></i> Add Genre</h4>
						<form action="genreInsertAction" method="post" class="form-horizontal style-form">
						
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 장르 아이디 </label>
                                
                                <div class="col-sm-10">
                                	<input type="text" id="genreId" name="genreId" class="form-control" />
                                </div>
                            </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
									<input type="text" id="genreUrl" name="genreUrl" class="form-control" />
								</div>
							</div>
